...
(function(){
	...
	AccountAPI.prototype.routes = function(app){
        ...
        app.get("/utilisateur/compte", this.undef); // todo
        app.post('/utilisateur/inscription', this.undef); //todo
        app.post('/utilisateur/connexion', this.undef); //todo
        app.post('/utilisateur/deconnexion', this.undef); //todo
	};
